...
with open("Biblioteca-matplot-seaborn-8/dados.yaml", "r") as file:
...
plt.figure(figsize=(8, 6))  # Criar uma figura com tamanho específico
sns.barplot(
    data=df, x="alunos", y="notas", palette="pastel"
)  # Plotar gráfico de barras com Seaborn
...
plt.figure(figsize=(8, 6))  # Criar uma figura com tamanho específico
plt.scatter(
    df["altura"], df["idade"], color="green", alpha=0.5
)  # Plotar gráfico de dispersão
plt.title(
    "Gráfico de Dispersão da Altura e Idade - Matplotlib"
...
plt.figure(figsize=(8, 6))  # Criar uma figura com tamanho específico
sns.scatterplot(
    data=df, x="altura", y="idade", color="purple", alpha=0.5
)  # Plotar gráfico de dispersão com Seaborn
plt.title(
    "Gráfico de Dispersão da Altura e Idade - Seaborn"
)  # Definir título do gráfico
plt.xlabel("Altura")  # Definir rótulo do eixo x
plt.ylabel("Idade")  # Definir rótulo do eixo y
plt.grid(True)  # Habilitar grade no gráfico
